# Protocol Reference — v1 (legacy)

> **This is the v1 contract** (`VektesProtocol`, `0xd0554A67…E8B7`). It stays live and immutable so transfers already scheduled on it can be claimed or rejected, but **new integrations should use v2** — see the [v2 Protocol Reference](./protocol-reference.md).
